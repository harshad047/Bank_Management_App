...
<nav class="sidebar text-white p-3">
    <h5><i class="fas fa-university"></i> Arya Vikas Bank</h5>
    <hr>
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/user/passbook" class="nav-link">
                <i class="fas fa-book"></i> Passbook
            </a>
        </li>
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/user/transaction" class="nav-link">
                <i class="fas fa-exchange-alt"></i> Transactions
            </a>
        </li>
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/user/transfer" class="nav-link">
                <i class="fas fa-money-check-alt"></i> Transfer
            </a>
        </li>
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/user/analysis" class="nav-link">
                <i class="fas fa-chart-line"></i> Monthly Analysis
            </a>
        </li>
        <li class="nav-item">
